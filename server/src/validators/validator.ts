 ...
 * 2) Error checking middleware that has access to API request. This middleware calls validationResult() method and checks for any errors attached to the request(validateValues). If it finds some errors, it joins them into single string and throws an error
