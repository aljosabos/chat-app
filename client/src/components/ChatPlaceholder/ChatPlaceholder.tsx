...
export const ChatPlaceholder = () => {
  return (
    <div className="dark:bg-dark-2 h-full w-full border-l dark:border-l-dark-border-2 border-b-[6px] border-b-green-2 flex flex-col justify-center items-center">
      <Logo />
